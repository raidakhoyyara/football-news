...
SECRET_KEY = 'django-insecure-9%r&-ucw(^*=01s&o4%h-bgp%)tj!$#v_5cg7)ni@lb)0pt$0r'
...
ALLOWED_HOSTS = ["localhost", "127.0.0.1", "raida-khoyyara-footballnews.pbp.cs.ui.ac.id","10.0.2.2"]
